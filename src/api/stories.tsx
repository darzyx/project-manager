...
const stories: StoriesType = {
  "HAE-0001": {
    ...
    date_created: "Jan 1st, 2022",
    date_due: "Jan 1st, 2022",
    points: points.one,
  ...
  "HAE-0002": {
    ...
    date_created: "Jan 8th, 2022",
    date_due: "Jan 8th, 2022",
    points: points.two,
  ...
  "HAE-0003": {
    ...
    date_created: "Jan 25th, 2022",
    date_due: "Jan 25th, 2022",
    points: points.three,
  ...
  "HAE-0004": {
    ...
    description: undefined,
    date_created: "Dec 20th, 2021",
    date_due: "Dec 20th, 2021",
    points: points.five,
  ...
  "HAE-0005": {
    ...
    date_created: "Oct 30th, 2021",
    date_due: "Oct 30th, 2021",
    points: points.eight,
  ...
  "HAE-0006": {
    ...
    date_created: "Jan 10th, 2022",
    date_due: "Jan 10th, 2022",
    points: points.one,
    completion: completions.backlogged,
    kind: kinds.task,
    assignee: assignees.aaron,
  ...
  "HAE-0007": {
    ...
    date_created: "Feb 5th, 2022",
    date_due: "Feb 5th, 2022",
    points: points.two,
  ...
  "HAE-0008": {
    ...
    date_created: "Feb 1st, 2022",
    date_due: "Feb 1st, 2022",
    points: points.three,
    completion: completions.deployed,
    kind: kinds.bug,
    assignee: assignees.carlos,
  ...
  "HAE-0009": {
    ...
    date_created: "Mar 15th, 2022",
    date_due: "Mar 15th, 2022",
    points: points.five,
    completion: completions.started,
    kind: kinds.feature,
    assignee: assignees.daisy,
  ...
  "HAE-0010": {
    ...
    date_created: "Mar 18th, 2022",
    date_due: "Mar 18th, 2022",
    points: points.eight,
    completion: completions.archived,
    kind: kinds.feature,
    assignee: assignees.unspecified,
  ...
  "HAE-0011": {
    ...
    date_created: "Mar 20th, 2022",
    date_due: "Mar 20th, 2022",
    points: points.five,
    completion: completions.archived,
    kind: kinds.feature,
    assignee: assignees.aaron,
  ...
  "HAE-0012": {
    ...
    description: undefined,
    date_created: "Dec 5th, 2021",
    date_due: "Dec 14th, 2021",
    points: points.five,
    completion: completions.reviewing,
    kind: kinds.task,
    assignee: assignees.benny,
  ...
  "HAE-0013": {
    ...
    date_created: "Dec 11th, 2021",
    date_due: "Dec 11th, 2021",
    points: points.five,
    completion: completions.reviewing,
  ...
  "HAE-0014": {
    ...
    date_created: "Nov 3rd, 2021",
    date_due: "Nov 3rd, 2021",
    points: points.three,
    completion: completions.backlogged,
    kind: kinds.feature,
    assignee: assignees.carlos,
  ...
  "HAE-0015": {
    ...
    date_created: "Oct 7th, 2021",
    date_due: "Oct 7th, 2021",
    points: points.three,
    completion: completions.reviewing,
    kind: kinds.feature,
    assignee: assignees.aaron,
  ...
  "HAE-0016": {
    ...
    date_created: "Nov 14th, 2021",
    date_due: "Nov 14th, 2021",
    points: points.three,
    completion: completions.scheduled,
    kind: kinds.bug,
    assignee: assignees.unspecified,
  ...
  "HAE-0017": {
    ...
    date_created: "Aug 6th, 2021",
    date_due: "Aug 6th, 2021",
    points: points.three,
    completion: completions.scheduled,
    kind: kinds.task,
    assignee: assignees.carlos,
